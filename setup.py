...
setup(
    ...
    extras_require={"art-plugin": ["pillow==8.*,>=8.0.1", "pylast==4.*,>=4.0.0", "requests==2.*,>=2.25.0"], "dev": ["cogapp==3.*,>=3.0.0", "gitchangelog", "nicfit.py[cookiecutter]==0.*,>=0.8.7", "paver==1.*,>=1.3.4", "pyaml==20.*,>=20.4.0", "regarding==0.*,>=0.1.4", "sphinx==3.*,>=3.3.1", "sphinx-issues==1.*,>=1.2.0", "sphinx-rtd-theme==0.*,>=0.5.0", "tox==3.*,>=3.20.1", "twine==3.*,>=3.2.0", "wheel==0.*,>=0.36.1"], "display-plugin": ["grako==3.*,>=3.99.9"], "yaml-plugin": ["ruamel.yaml==0.*,>=0.16.12"]},
)
